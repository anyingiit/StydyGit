...
There is nothing to install or run: this repository has no manifest, no entry point, and no source file in any language, only the scratch files described in [About The Project](README.md#about-the-project). See [Getting started](README.md#getting-started) for cloning it.
